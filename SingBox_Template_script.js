...
config.outbounds.map(i => {
  ...
  i.outbounds.push(...proxies.filter(p => !/港|香港|hk|hongkong|kong kong|🇨🇳|济南|杭州|广州|徐州|浙江|🇯🇵|日本|東京|jp|Japan|🇭🇰|台|台灣|tw|taiwan|🇹🇼|新|sg|singapore|🇸🇬|美|us|Oregon|Oregon|unitedstates|united states|united states|🇺🇸|韩|kr|서울|Korea|🇰🇷/i.test(p.tag)).map(p => p.tag))
  }
